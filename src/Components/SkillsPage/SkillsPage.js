...
function SkillsPage(props) {
    return (
			<section
				className='skills-page-container container-fluid d-flex flex-column justify-content-center'
				id='skills'>
				...
				<div className='skills-svg-container flex-wrap d-flex container justify-content-center'>
					...
					<i className='icon p-1 devicon-java-plain-wordmark colored'></i>
					...
					<i className='icon p-1 devicon-nodejs-plain-wordmark colored'></i>
					<i className='icon p-1 devicon-mongodb-plain-wordmark colored'></i>
					<i className='icon p-1 devicon-express-original-wordmark'></i>
					<i className='icon p-1 devicon-django-plain-wordmark colored'></i>
					<i className='icon p-1 devicon-postgresql-plain-wordmark colored'></i>
				</div>
			</section>
		);
}
